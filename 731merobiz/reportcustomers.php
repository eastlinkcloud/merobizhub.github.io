...
$query = "SELECT c.*, ca.category_name, p.product_name, cn.name as province_name, s.name as district_name, m.name as municipality_name
          ...
          WHERE salesmanager_id=:salesmanager_id";
$params = array(':salesmanager_id' => $salesmanager_id);
...
<a class="sidebar-brand d-flex align-items-center justify-content-center fw-bold " href="salesdashboard.php">
