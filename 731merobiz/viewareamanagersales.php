...
if (isset($_GET['salesmanager_id'])) {
    ...
    $query = "SELECT * FROM salesmanager WHERE d_id=$_SESSION[myuser] AND status='Active'  ORDER BY salesmanager_id ASC";
    ...
    header('Location: areamanagerdashobard.php');
    exit();
}
?>
