...
$query .= " ORDER BY c.salesmanager_id DESC";
...
<a class="sidebar-brand d-flex align-items-center justify-content-center fw-bold " href="areamanagerdashboard.php">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item  text-white">
                            <a class="nav-link dropdown-toggle text-white" href="#" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline  text-capitalize text-white">Area</span>
...
<h3 style="margin-left: 1%; margin-bottom:-42px; font-weight:bold;">SalesPoint List</h3>
                <thead>
                    <tr>
