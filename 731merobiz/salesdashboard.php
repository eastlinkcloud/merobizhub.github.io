    ...
    <div class="card  border-left-info shadow" style="background:#000099;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <!-- total area manager -->
                <?php
              $query = "SELECT * FROM customer WHERE salesmanager_id=:salesmanager_id";
      ...
      <a href="salescustomeractive.php" class="ahref text-white text-center">View Details</a>
    </div>
</div>
<!-- refer -->
    ...
    <div class="card border-left-info shadow" style="background:#000099;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <!-- total area manager -->
                <?php
              $query = "SELECT * FROM resellerwallet WHERE salesmanager_id=:salesmanager_id";
          $stmt = $conn->prepare($query);
          $stmt->bindParam(':salesmanager_id', $_SESSION['myuser']);
          $stmt->execute();
          $serial = 1; // initialize counter variable
      ...
      <a href="salesreceipt.php" class="ahref text-center text-white" >View Details</a>
    </div>
</div>
...
$query = "SELECT COUNT(*) AS total_customers
          FROM customer
          WHERE DATE(created_at) = CURDATE() AND salesmanager_id = :salesmanager_id"; // Retrieve only today's data
$stmt = $conn->prepare($query);
...
if ($stmt->rowCount() > 0) {
    ...
    echo "<center style='font-weight:bold; color:white;'>$total_customers</center>";
} else {
...
?>
                                ...
                                <a href="salestodaycustomer.php"><p class="text-white m-0">view all</p></a>
                              </div>
                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                <h3 class="m-0 survey-value text-white">
                                <?php
$query = "SELECT * FROM customer WHERE status='Pending' AND salesmanager_id = :salesmanager_id";
$stmt = $conn->prepare($query);
$stmt->bindParam(':salesmanager_id', $salesmanager_id);
$stmt->execute();
$total_rows = $stmt->rowCount(); // get total number of rows
...
?>
                                ...
                                <a href="salescustomerpending.php"><p class="text-white m-0">view all</p></a>
                              </div>
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-line-fill  text-white" viewBox="0 0 16 16">
  <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2z"/>
</svg>
                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                <h3 class="m-0 survey-value text-white">
                                <?php
$query = "SELECT * FROM customer WHERE status='Process' AND salesmanager_id = :salesmanager_id";
$stmt = $conn->prepare($query);
$stmt->bindParam(':salesmanager_id', $salesmanager_id);
$stmt->execute();
$total_rows = $stmt->rowCount(); // get total number of rows
...
?>
                                ...
                                <a href="salescustomerprocess.php"><p class="text-white m-0">view all</p></a>
                              </div>
                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                <h3 class="m-0 survey-value text-white">
                                <?php
$query = "SELECT * FROM refer WHERE salesmanager_id = :salesmanager_id";
$stmt = $conn->prepare($query);
$stmt->bindParam(':salesmanager_id', $salesmanager_id);
$stmt->execute();
$total_rows = $stmt->rowCount(); // get total number of rows
...
?>
                                ...
                                <a href="refferal.php"><p class="text-white m-0">view all</p></a>
                              </div>
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-line-fill  text-white" viewBox="0 0 16 16">
  <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2z"/>
</svg>
