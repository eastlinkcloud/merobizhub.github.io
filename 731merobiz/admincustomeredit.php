...
if(isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("UPDATE customer SET customer_name = ?, mobilenumber = ?, streetno = ?, wardno = ?, email = ?, status = ? WHERE customer_id = ?");
...
$_SESSION['customer_update_success'] = true;
    ...
    header('Location: admincustomeractive.php');
    exit;
}
